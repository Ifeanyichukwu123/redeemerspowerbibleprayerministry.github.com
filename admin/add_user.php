...
$query = mysqli_query($conn,"select * from admin where username = '$username' and password = '$password' and firstname = '$firstname' and password = '$password' ");
...
mysqli_query($conn,"insert into admin (username,password,firstname,lastname,adminthumbnails) values('$username','$password','$firstname','$lastname','images/NO-ImAGE-AVAILABLE.jpg')");

mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Add System User $firstname')");
?>
<script>
