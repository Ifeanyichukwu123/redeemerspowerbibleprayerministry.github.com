		                        ...
		                        <div id="" class="block">
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									    ...
									    <div class="control-group">
											...
											<div class="controls">			
												<select id="qtype" name="dev_id" readonly="readonly" required>
													...
													<?php
													$device_query = mysqli_query($conn,"select * from device_name");
										...
										mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Update Status $dev_name to $dev_status')");			
										?>
										<script>
