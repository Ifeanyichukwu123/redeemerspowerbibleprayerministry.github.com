...
$query = mysqli_query($conn,"select * from visitor where  mobile = '$mobile'  ");
...
values('$fname','$sname','$lname','$Gender','$birthday','$residence','$pob','$ministry','$mobile','uploads/none.png')");
