				 ...
				 <div class="navbar-header">
				  ...
				  <!--.nav-collapse -->
                    <div class="nav-collapse collapse">
						...
						<?php $query= mysqli_query($conn,"select * from members where id = '$session_id'")or die(mysql_error());
							  $row = mysqli_fetch_array($query);
						?>
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"><img id="avatar1" class="img-responsive" src="<?php echo $row['thumbnail']; ?>">&nbsp;<?php echo $row['fname']." ".$row['lname'];  ?> <i class="caret"></i>
                                </a>
